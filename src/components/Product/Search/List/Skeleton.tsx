    ...
    return Array.from({ length: rowCount ?? DEFAULT_ROW_COUNT }).map(
      (_, index) => (
        <li
          key={index}
          role="status"
          className="animate-pulse flex justify-start items-center odd:bg-white even:bg-gray-50 px-7 py-4"
        >
          <div className="flex flex-none w-[100px] h-[100px] bg-gray-300">
            <svg
              className="m-auto w-10 h-10 text-gray-200 dark:text-gray-600"
              aria-hidden="true"
